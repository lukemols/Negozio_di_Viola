...
{
    public partial class Negozio3 : Form
    {
        HomePage home;
        //Fumetto dialogo; //inutile, si potrà cancellare //[RIV]
        Fumetto2 fumetto2form;//Fumetto2 OK //[RIV]
                    ...
                    foreach (Control c in panelScaffale.Controls)
                    {
                        if (c.Tag.ToString() == i.ToString())
                            if (c is System.Windows.Forms.PictureBox)
                                ...
                                ((Label)c).Text = "???";//p.PrezzoVendita.ToString("0.00") + "€";//[RIV]
                    }
                }
                else
                {
        ...
        {
            //quando si preme il tasto avanti si passa al Fumetto2
            this.Close();
